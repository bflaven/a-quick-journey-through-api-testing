...
# cd /path-to-your-test/002_flagapi_v2_get_all/
...
POSTMAN_COLLECTION="002_flagapi_v2_get_all.postman_collection.json"; 

### --- POSTMAN_SAMPLE_DATA --- ###
PATH_POSTMAN_SAMPLE_DATA="$PWD/dat/"
POSTMAN_SAMPLE_DATA="dat_flagapi_v2_get_all.postman_sample_data.json";

### --- POSTMAN_ENVIRONMENT --- ###
PATH_POSTMAN_ENVIRONMENT="$PWD/env/"
POSTMAN_ENVIRONMENT="env_flagapi_v2_get_all.postman_environment.json";


### ---  FILENAME FOR REPORT --- ###
PATH_FILENAME_FOR_REPORT="$PWD/reports/"
FILENAME_FOR_REPORT="report_flagapi_v2_get_all_$(date +%Y_%m_%d_%H_%M_%S).html"
